...
var people = ["Nahum", "Yael", "Ron", "Maya", "Ely", "Tony", "Nathan", "Adam", "Brandon", "Jaxon", "Preston", "Skyler", "Grace"]
let sortedCollection1 = people.sorted(by: forwards(name1:name2:))
print("\n\(sortedCollection1)")
...
let sortedCollection2 = people.sorted(by: { (lhs: String, rhs: String) -> Bool in
    return lhs < rhs
})
...
let sortedCollection3 = people.sorted(by: {$0 < $1})
