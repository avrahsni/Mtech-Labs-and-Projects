...
//print("The value of foo is \(foo)")
// It will not compile because the variable 'foo' only exists within the scope of the for loop
...
// This code compiles because a x is defined outside of the for loop so it can be accessed both inside and outside the loop
...
greeting(greeting: "Hello there", name: "General Kenobi")
greeting(greeting: nil, name: "Kitty")
