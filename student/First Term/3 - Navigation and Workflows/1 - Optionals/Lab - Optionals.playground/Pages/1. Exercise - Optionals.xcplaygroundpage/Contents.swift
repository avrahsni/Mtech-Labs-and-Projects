...
print(userAge)
//The value of 'userAge' is 'nil' because it is an optional int type so if it is not initialized with an int then it will be nil
/*:
 ...
 */
//It says Optional() with the value in the parentheses
print(userAge!)
