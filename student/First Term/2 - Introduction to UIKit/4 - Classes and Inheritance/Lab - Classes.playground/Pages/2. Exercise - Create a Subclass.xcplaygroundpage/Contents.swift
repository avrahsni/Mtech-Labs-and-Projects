...
//print(falcon.weapon)
//This doesn't work because falcon doesn't exist in this context, it was created in the previous exercise.  If it did exist in this exercise, it still wouldn't work because falcon was an instance of Spaceship, not of Fighter so it doesn't have the weapon property.
