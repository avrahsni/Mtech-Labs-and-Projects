 ...
 */
var walkChallenge = ["Walk 3 miles a day", "Walk for 15 minutes straight every day"]
var runChallenge = ["Run 5 times a week", "Run a mile in under 8.5 minutes"]
...
if comChal.isEmpty {
    print("You are lazy.  You need to commit to a challenge or else your ancestors will be ashamed of you")
}
else if comChal.count == 1 {
    print("The challenge you have chosen is \(comChal)")
}
else {
