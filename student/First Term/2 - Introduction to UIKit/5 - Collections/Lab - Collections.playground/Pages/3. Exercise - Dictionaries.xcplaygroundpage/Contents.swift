...
if let janDays = daysInMonth.updateValue(31, forKey: "January") {
    print("January has \(janDays) days.")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["square", "rectangle", "trapezoid", "hexagon"]
var colorsArray = ["red", "blue", "green", "yellow"]
var arrDict = ["Shapes": shapesArray, "Colors": colorsArray]
print(arrDict)
...
print(arrDict["Colors"]![3])
if let color = arrDict["Colors"] {
    print(color[3])
}
/*:
