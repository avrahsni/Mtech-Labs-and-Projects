...
var run1 = RunningWorkout(distance: 3200, time: 13, elevation: 74)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congratulations! You reached your step goal for the day.")
            }
        }
    }
    var goal: Int
...
var walk = Steps(steps: 9999, goal: 10000)
walk.takeStep()
walk.steps
/*:
