...
print("In this workout session, you have run a total of \(firstRun.distance) meters in \(firstRun.time) minutes and have gained a total of \(firstRun.elevation) meters in elevation")
/*:
