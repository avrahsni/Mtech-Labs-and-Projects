...
var Snir = User(name: "Snir Avrahami", age: 17, height: 65.5, weight: 130, activityLevel: 6)
print("User \(Snir.name) is \(Snir.age) years old, weighs \(Snir.weight)lbs, is \(Snir.height) inches tall, and has an activity level of \(Snir.activityLevel)")
