...
var comp1 = Laptop(yearPurchased: 2022)
var comp2 = Laptop(yearPurchased: 2019)
/*:
...
var tallness = Height(heightInInches: 65)
print(tallness.heightInCentimeters)
...
var myHeight = Height(heightInInches: 65.5)
